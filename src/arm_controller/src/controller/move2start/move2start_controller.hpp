#ifndef __MOVE2START_CONTROLLER_HPP__
#define __MOVE2START_CONTROLLER_HPP__
...
class Move2StartController final : public UtilityControllerBase {
public:
    explicit Move2StartController(const rclcpp::Node::SharedPtr& node);
    ~Move2StartController() override = default;
...
private:
    ...
    // 核心功能函数
    bool move_to_start_position(const std::string& mapping);
...
#endif      // __MOVE2START_CONTROLLER_HPP__
